...
/// Builds an illustration that will be used as a background-image for the Home Widget.
/// It is rendered off-screen with the [HomeWidget.renderFlutterWidget] API
