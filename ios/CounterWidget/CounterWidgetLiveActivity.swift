...
struct CounterWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = CounterWidgetAttributes(name: "Me")
    static let contentState = CounterWidgetAttributes.ContentState(value: 3)
